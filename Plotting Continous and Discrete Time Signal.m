...
title('Task 1: Plotting a Sinusoidal Signal')

%% Task 2: Plotting a Composite CT Sinusoid
...
xlabel('Time (sec)')
ylabel('Sinusoids')
title('Task 2: Plotting a Sinusoidal Signals')
...
%% Task 3: Plotting a CT Piecewise Signal
...
xlabel('Time (sec)')
ylabel('Amplitude')
title('Task 3: Plotting a Piecewise Continuous-Time Signal')
axis([-5 +5 -1.5 +2.5])

%% Task 4: Plottinng a Periodic DT Sinusoid
...
xlabel('n')
ylabel('x[n]')
title('Task 4: Periodic Sinusoidal Sequence with wo = pi/8')

%% Task 5: Plotting a Composite DT Signal
...
xlabel('n')
ylabel('x_1[n]')
title('Task 5: Periodic Sinusoidal Sequences with wo = 3*pi/8, pi/6 and pi/4')
